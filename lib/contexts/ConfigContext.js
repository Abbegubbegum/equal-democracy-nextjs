...
export function ConfigProvider({ children }) {
	...
	useEffect(() => {
		...
		root.style.setProperty('--theme-primary-100', theme.colors.primary[100]);
		root.style.setProperty('--theme-primary-400', theme.colors.primary[400]);
		root.style.setProperty('--theme-primary-500', theme.colors.primary[500]);
		root.style.setProperty('--theme-primary-600', theme.colors.primary[600]);
		root.style.setProperty('--theme-primary-700', theme.colors.primary[700]);
		root.style.setProperty('--theme-primary-800', theme.colors.primary[800]);
		root.style.setProperty('--theme-primary-900', theme.colors.primary[900]);
