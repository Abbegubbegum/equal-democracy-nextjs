...
export const de = {
	...
	phases: {
		...
		transitionMessage:
			"Genügend Benutzer und Vorschläge wurden bewertet. Das System wechselt bald zu Debatte und Abstimmung, wo wir zuerst über die besten Vorschläge diskutieren und schließlich abstimmen.",
	...
	voting: {
		...
		limitedVotingRights:
			"Eingeschränktes Stimmrecht - Demokratische Innovation",
		oneVotePerSession:
			"In Gleiche Demokratie hat jeder Teilnehmer das Recht, nur für einen (1) Vorschlag pro Runde zu stimmen. Das bedeutet, dass Sie Prioritäten setzen und den für Sie wichtigsten Vorschlag auswählen müssen.",
		votingAdvantages:
			"Vorteile: Weniger Arbeitsaufwand für die Teilnehmer, während jede Stimme mehr Gewicht und Durchschlagskraft erhält. Sie müssen nicht zu allen Fragen Stellung nehmen, aber Ihre Stimme bedeutet mehr, wo Sie sie einsetzen.",
	...
	dashboard: {
		...
		votes: "Stimmen",
		comments: "Kommentare",
		finalVotes: "Endgültige Stimmen",
		myProposals: "Meine Vorschläge",
		noProposals: "Sie haben noch keine Vorschläge erstellt",
		proposalsVotedOn: "Vorschläge, für die ich gestimmt habe",
		noVotes: "Sie haben noch für keine Vorschläge gestimmt",
		myComments: "Meine Kommentare",
		noComments: "Sie haben noch keine Vorschläge kommentiert",
		myFinalVotes: "Meine Endgültigen Stimmen",
		noFinalVotes: "Sie haben noch keine endgültigen Stimmen abgegeben",
		on: "Bei",
		active: "Aktiv",
		top3: "Top 3",
		archived: "Archiviert",
