...
export const en = {
	...
	phases: {
		...
		transitionMessage: 'Enough users and proposals have been rated. The system will soon transition to debate and voting where we first discuss and finally vote on the top proposals.',
	...
	proposals: {
		...
		clickToDebateAndVote: 'Click on a proposal to see arguments and discuss. When the debate is complete, choose a question to cast your vote on.',
		debate: 'Debate',
