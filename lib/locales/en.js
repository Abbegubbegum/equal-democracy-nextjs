...
export const en = {
	...
	phases: {
		...
		transitionMessage:
			"Enough users and proposals have been rated. The system will soon transition to debate and voting where we first discuss and finally vote on the top proposals.",
	...
	proposals: {
		...
		howToImproveYourSpace: "How would you improve?",
		count: "({count})",
	...
	voting: {
		...
		oneVotePerSession:
			"In Equal Democracy, each participant has the right to vote on only one (1) proposal per round. This means you must prioritize and choose the proposal that is most important to you.",
		votingAdvantages:
			"Advantages: Less workload for participants, while each vote carries greater weight and impact. You don't have to take a position on all issues, but your vote means more where you choose to use it.",
	...
	dashboard: {
		...
		noProposals: "You haven't created any proposals yet",
		proposalsVotedOn: "Proposals I voted on",
		noVotes: "You haven't voted on any proposals yet",
		myComments: "My Comments",
		noComments: "You haven't commented on any proposals yet",
		myFinalVotes: "My Final Votes",
		noFinalVotes: "You haven't cast any final votes yet",
		on: "On",
		active: "Active",
		top3: "Top 3",
		archived: "Archived",
