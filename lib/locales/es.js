...
export const es = {
	...
	phases: {
		...
		transitionMessage: 'Suficientes usuarios y propuestas han sido calificados. El sistema pronto pasará al debate y votación donde discutimos y votamos sobre las mejores propuestas.',
	...
	proposals: {
		...
		clickToDebateAndVote: 'Haz clic en una propuesta para ver argumentos y discutir, o ve a votar',
		debate: 'Debatir',
		...
		howToImproveYourSpace: '¿Cómo mejorarías tu espacio?',
		count: '({count})',
	...
	rating: {
		...
		createProposalNudge: '¿Has considerado crear tu propia propuesta primero? Siempre puedes calificar otras después.',
	},
