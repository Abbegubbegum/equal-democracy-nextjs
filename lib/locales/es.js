...
export const es = {
	...
	phases: {
		...
		transitionMessage:
			"Suficientes usuarios y propuestas han sido calificados. El sistema pronto pasará al debate y votación donde primero discutimos y finalmente votamos sobre las mejores propuestas.",
	...
	voting: {
		...
		limitedVotingRights:
			"Derecho de voto limitado - Innovación democrática",
		oneVotePerSession:
			"En Democracia Igualitaria, cada participante tiene derecho a votar solo por una (1) propuesta por ronda. Esto significa que debes priorizar y elegir la propuesta que es más importante para ti.",
		votingAdvantages:
			"Ventajas: Menos carga de trabajo para los participantes, mientras que cada voto obtiene mayor peso e impacto. No tienes que tomar posición sobre todas las cuestiones, pero tu voto significa más donde eliges usarlo.",
	...
	dashboard: {
		...
		noProposals: "Aún no has creado ninguna propuesta",
		proposalsVotedOn: "Propuestas en las que voté",
		noVotes: "Aún no has votado en ninguna propuesta",
		myComments: "Mis Comentarios",
		noComments: "Aún no has comentado en ninguna propuesta",
		myFinalVotes: "Mis Votos Finales",
		noFinalVotes: "Aún no has emitido ningún voto final",
		on: "En",
		active: "Activo",
		top3: "Top 3",
		archived: "Archivado",
