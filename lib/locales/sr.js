...
export const sr = {
	...
	phases: {
		...
		transitionMessage:
			"Dovoljno korisnika i predloga je ocenjeno. Sistem uskoro prelazi na debatu i glasanje gde prvo raspravljamo i na kraju glasamo o najboljim predlozima.",
	...
	proposals: {
		...
		howToImproveYourSpace: "Kako želite da unapredite?",
		count: "({count})",
	...
	voting: {
		...
		oneVotePerSession:
			"U Jednakoj Demokratiji svaki učesnik ima pravo da glasa samo za jedan (1) predlog po rundi. To znači da morate da odredite prioritete i izaberete predlog koji vam je najvažniji.",
		votingAdvantages:
			"Prednosti: Manje opterećenje za učesnike, dok svaki glas dobija veću težinu i uticaj. Ne morate da se izjašnjavate o svim pitanjima, ali vaš glas znači više tamo gde ga koristite.",
	...
	dashboard: {
		...
		votes: "Glasovi",
		comments: "Komentari",
		finalVotes: "Završni glasovi",
		myProposals: "Moji predlozi",
		noProposals: "Još niste kreirali nijedan predlog",
		proposalsVotedOn: "Predlozi za koje sam glasao/la",
		noVotes: "Još niste glasali ni za jedan predlog",
		myComments: "Moji komentari",
		noComments: "Još niste komentarisali nijedan predlog",
		myFinalVotes: "Moji završni glasovi",
		noFinalVotes: "Još niste dali nijedan završni glas",
		on: "Na",
		active: "Aktivan",
		top3: "Top 3",
		archived: "Arhivirano",
