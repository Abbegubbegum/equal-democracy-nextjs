...
export const sv = {
	...
	phases: {
		...
		transitionMessage: 'Tillräckligt många användare och förslag har betygssatts. Systemet övergår snart till debatt och omröstning där vi diskuterar och röstar om toppförslagen.',
	...
	proposals: {
		...
		clickToDebateAndVote: 'Klicka på ett förslag för att se argument och diskutera, eller gå till omröstning',
		debate: 'Debattera',
		...
		howToImproveYourSpace: 'Hur skulle du förbättra ditt utrymme?',
		count: '({count})',
	...
	rating: {
		...
		createProposalNudge: 'Har du övervägt att skapa ditt eget förslag först? Du kan alltid betygsätta andras efteråt.',
	},
