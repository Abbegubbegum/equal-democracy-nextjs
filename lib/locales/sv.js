...
export const sv = {
	...
	phases: {
		...
		transitionMessage:
			"Tillräckligt många användare och förslag har betygssatts. Systemet övergår snart till debatt och omröstning där vi först diskuterar och slutligen röstar om toppförslagen.",
	...
	voting: {
		...
		oneVotePerSession:
			"I Jämlik Demokrati har varje deltagare rätt att rösta på endast ett (1) förslag per omgång. Detta innebär att du måste prioritera och välja det förslag som är viktigast för dig.",
		votingAdvantages:
			"Fördelar: Mindre arbetsbörda för deltagarna, samtidigt som varje röst får större tyngd och genomslagskraft. Du slipper ta ställning till alla frågor, men din röst betyder mer där du väljer att använda den.",
	...
	dashboard: {
		...
		finalVotes: "Slutröster",
		myProposals: "Mina förslag",
		noProposals: "Du har inte skapat några förslag än",
		proposalsVotedOn: "Förslag jag röstat på",
		noVotes: "Du har inte röstat på några förslag än",
		myComments: "Mina kommentarer",
		noComments: "Du har inte kommenterat på några förslag än",
		myFinalVotes: "Mina slutröster",
		noFinalVotes: "Du har inte avgett några slutröster än",
		on: "På",
		active: "Aktiv",
		top3: "Topp 3",
		archived: "Arkiverad",
	...
	email: {
		...
		sessionResults: {
			...
			noVotes: "nej-röster",
			electionPromise:
				"Om vi vinner valet lovar vi att driva dessa förslag och ge möjlighet att påverka lokalpolitiken på en helt ny nivå.",
