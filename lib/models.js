...
const ProposalSchema = new mongoose.Schema(
	{
		...
		estimatedCost: {
			...
			maxlength: [100, "Cost estimate cannot be more than 100 characters"],
		},
...
export const CommentRating =
	mongoose.models.CommentRating || mongoose.model("CommentRating", CommentRatingSchema);
...
export const TopProposal =
	mongoose.models.TopProposal || mongoose.model("TopProposal", TopProposalSchema);
